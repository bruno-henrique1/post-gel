...
from postt.utils.rands import slugify_new
from django.contrib.auth.models import User
from postt.utils.images import resize_image
...
class Page(models.Model):
    ...
    def get_absolute_url(self):
        if not self.is_published:
            return reverse('postt:postt')
        return reverse('postt:page', args=(self.slug,))
...
class Post(models.Model):
    ...
    categoryy = models.ForeignKey(
        Categoryy, on_delete=models.SET_NULL, null=True, blank=True,
        default=None,
    )
    ...
    def get_absolute_url(self):
        if not self.is_published:
            return reverse('postt:postt')
        return reverse('postt:post', args=(self.slug,))
