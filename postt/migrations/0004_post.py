    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoryy', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='postt.categoryy')),
                ...
                ('tags', models.ManyToManyField(blank=True, default='', to='postt.tag')),
